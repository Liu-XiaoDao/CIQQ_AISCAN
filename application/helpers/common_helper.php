...
function remsg($content = '未知的异常',$type = 4,$back = false)
{
    switch($type)
    {
        case 1:
    ...
    $con = '<div class="panel panel-'.$panel.'">
      <div class="panel-heading">
        <h3 class="panel-title">提示信息</h3>
        </div>
        <div class="panel-body">';
    ...
    if ($back) {
        $con.='<hr/><a href="'.$back.'"><< 返回上一页</a>';
    }else{
        $con.='<hr/><a href="javascript:history.back(-1)"><< 返回上一页</a>';
    }
...
function checkIfActive($string,$c='home') {
