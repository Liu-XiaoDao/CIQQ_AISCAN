...
?>
  ...
  <tr>
    <td><a href="/index.php/front/order/detail/<?php echo $order['trade_no']; ?>"><?php echo $order['trade_no']; ?></a></td>
    ...
    <td><a href="/index.php/front/order/detail/<?php echo $order['trade_no']; ?>" class="btn btn-info btn-xs">查看购买号码</a></td>
  </tr>
<?php   }  ?>
